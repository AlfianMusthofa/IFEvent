...
const Sponsors = () => {
  return (
    <div className="container mx-auto py-[10px] my-[15px]">
      <p className="text-center mb-[20px] text-[17px] font-semibold tracking-wider">
        TRUSTED BY THE MOST AMBITIOUS PARTNERS
      </p>
      <Marquee gradient={true} className="max-w-[1029px] mx-auto">
